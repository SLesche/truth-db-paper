...
As TED continues to grow, we encourage researchers not only to contribute data but also to build on TED’s infrastructure itself. TED itself is an extension of the ACDC project, improving on data submission and ease-of-use and can as a blueprint and jumping-off point for future database development. All aspects of the project—including the SQL schema, submission interface, R extraction package, and the interactive overview website—are open source and fully forkable. Researchers are invited to reuse or adapt these components to develop similar infrastructures for other domains of psychological or behavioral science. In doing so, TED can help establish a broader culture of open, scalable, and sustainable data practices in experimental research.

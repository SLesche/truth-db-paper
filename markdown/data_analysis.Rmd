...
load(file = "./markdown/data/model_check_likert.Rdata")
load(file = "./markdown/data/model_re_dichotomous.Rdata")
load(file = "./markdown/data/model_re_likert.Rdata")
...
save(model_check_likert, file = "./markdown/data/model_check_likert.Rdata")
save(model_re_dichotomous, file = "./markdown/data/model_re_dichotomous.Rdata")
save(model_re_likert, file = "./markdown/data/model_re_likert.Rdata")

# Retentions-Intervall Länge noch mit aufnehmen?

model_re_likert <- brms::brm(
  bf(response ~ repeated + (1 + repeated | subject) + (1 + repeated | statement_id) + (1 + repeated | procedure_id),
     sigma ~ repetition_instruction_timing),
  data = scale_data,
  warmup = 1000,
  iter = 2000,
  thin = 1,

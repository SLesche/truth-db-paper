...
```{r database-overview-plot,  fig.cap = paste("(ref:database-overview-plot)"), out.width="90%"}
knitr::include_graphics(
 path = "./markdown/data/ted-overview.png"
)
```
...
### Data Selection
**Something about submission criteria, which data are even allowed**
...
### Data Analysis 
**something about the meta-analysis we will run here**